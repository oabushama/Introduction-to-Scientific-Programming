...
\renewenvironment{frame}[2][keyword]
                 {\textsl{#2}\par
                   \begingroup \raggedright \leftskip=.5\unitindent
                 }
                 {\endgroup}
...
{ \catcode`\_=13
  \gdef\indexmpishow#{\bgroup \innocentcharacters
    \catcode`\_=13 \def_{\char95\discretionary{}{}{}}
    \def\\{\char`\\}\relax
    \tt \afterassignment\mpitoindex\edef\indexedmpi}
  \gdef\indexmpidef#{\bgroup \innocentcharacters
    \catcode`\_=13 \def_{\char95\discretionary{}{}{}}
    \def\\{\char`\\}\relax
...
\def\mpitoindex{%
  ...
  \edef\idxtmp{%
    ...
    %\noexpand\index{\indexedmpi@{\protect\innocentcharacters\protect\texttt{\indexedmpi}}}%
  }%
  \idxtmp
  \egroup
}
...
\def\mpitoindexbf{%
  ...
  \edef\idxtmp{%
    ...
    %\noexpand\index{\indexedmpi@{\protect\innocentcharacters\protect\texttt{\indexedmpi}}|textbf}%
  }%
  \idxtmp
  \egroup
}
