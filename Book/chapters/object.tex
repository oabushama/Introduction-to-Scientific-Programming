...
\begin{block}{Definition of object}
  ...
  The structure of an object is given in a \indextermbus{class}{definition}.
\end{block}

Objects are defined by their functionality: that's what you use.
...
\begin{exercise}
  \label{ex:functor2}
  Can you extend that class so that it remembers a factor to scale by?
  %
