...
\end{verbatim}
\begin{itemize}
\item \texttt{icpc} : compiler. Alternative Gnu: use \indextermtt{g++}
  or \indextermtt{clang++} instead of \indextermtt{icpc}.
...
Other conversation are done through a \indexterm{cast}; see section~\ref{sec:cast}.
