...
specifications can be complexit. In that case, using \indextermtt{auto} is
quite convenient.)
...
\n{vector} class that is more convenient and safe.
...
\begin{block}{Dynamic extension}
  ...
  %
  \snippetwithoutput{vectorend}{array}{vectorend}
  %
  also \n{pop_back}, \n{insert}, \n{erase}.\\
