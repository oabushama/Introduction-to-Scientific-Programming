...
\begin{remark}
  ...
  looks like a non-resizable variant of \lstinline{vector}. However, it is limited to
...
\begin{slide}{Vector methods}
  ...
  \item Other functions: \lstinline{front}, \lstinline{back}.
...
Use the \lstinline{push_back} method to add elements at the end:
...
\begin{block}{Vector extension}
  ...
  You can also use \indextermtt{new} to allocate (see section~\ref{sec:cnew}):
