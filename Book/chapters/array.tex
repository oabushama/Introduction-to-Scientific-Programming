...
There are several ways of initializing a vector. Note that if you
don't initialize you can not rely on the elements being zero or so:
the memory for the vector has been reserved, but there is no guarantee
on what is in it.
