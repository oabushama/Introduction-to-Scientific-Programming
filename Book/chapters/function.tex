...
Above you saw the \indextermbus{function}{definition}
...
\begin{exercise}
  ...
  \item Write functions \n{f(x,y)} and \n{deriv(x,y)}, that compute
    $f_y(x)$ and $f_y'(x)$ for the definition of $f$ above.
...
mathematical functions, and is known as \indextermdef{functional
  ...
  function calling; there is no other code then function definitions
  and calls.}.
\begin{itemize}
