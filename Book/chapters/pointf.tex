...
The \indextermfort{pointer} definition
\begin{lstlisting}
real,pointer :: point_at_real
\end{lstlisting}
...
be declared as \indextermfort{target}
\begin{lstlisting}
real,target :: x
\end{lstlisting}
...
\begin{exercise}
  ...
  More sophisticated: use the \indextermfort{Write} function and the
  \indextermfort{advance} keyword:
\begin{lstlisting}
