...
\message {defining GSL}\acitem {GSL}{Guideline Support Library}
\message {defining GnuSL}\acitem {GnuSL}{GNU Scientific Library}
...
\message {defining TDD}\acitem {TDD}{Test-Driven Development}
\message {defining TLB}\acitem {TLB}{Translation Look-aside Buffer}
\message {defining TSP}\acitem {TSP}{Traveling Salesman Problem}
