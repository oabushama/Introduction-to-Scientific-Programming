...
int main(int argc,char **argv) {
  ...
  srand(10);
  {
    cout << "Test 1: see the most popular attactions get the longest queues" << endl;
  ...
  srand(10);
  {
    cout << "Test 2: people go the single attraction with the shortest queue" << endl;
    Complex queues(nqueues);
    queues.header();
  ...
  srand(10);
  {
    cout << "Test 3: people go the shortest queue by ratio" << endl;
    Complex queues(nqueues);
    queues.header();
    int total_add_per_minute = queues.throughput();
